...
import {
  ...
  SocialMedia,
  Balance_management,
} from "../components/projects/old-2";
import Ecommerce from "../components/projects/e-commerce";
import FocusCarousel from "../components/projects/carousel";
    ...
    <div className="bg-gradient-to-br max-w-full text-white w-screen from-stone-950 to-stone-700 no-scrollbar overflow-x-hidden">
      ...
      <div className="mt-10 px-10 space-y-10">
        ...
        <div className="space-y-5">
          ...
          <Lostronaunt />
          <SocialMedia />
          <div className=" bg-black/20 text-center text-3xl p-5 text-amber-400 m-5 rounded">
